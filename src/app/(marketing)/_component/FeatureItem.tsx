...
export function FeatureItem({
    ...
    return (
      ...
      <span className="group flex items-center justify-between p-6 md:py-8" data-reason>
        ...
        <span
            className="mx-4 flex-1 border-b-4 border-dotted border-current opacity-0 transition-opacity duration-300 group-hover:opacity-100 max-sm:hidden"/>
        <span
            className="mr-2 block transition-transform duration-200 group-hover:-rotate-45 group-hover:scale-125 max-sm:hidden">
